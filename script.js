    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Ariel Megidish משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '452aac55-7071-49d4-8293-168fd8f8bb38',
                    name: data.name || '',
                    email: data.email || '',
